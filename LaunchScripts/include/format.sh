...
echo -e "\n${print_orange}Create netcdf input files: ${no_color}${P4R_ENV} python -W ignore ${PYTHONSCRIPTS}format.py /${CONFIG}settings_format_${phaseformat}.yml /${CONFIG}settingsCreateInputPlan4res_${phasecreate}.yml ${DATASET}"
${P4R_ENV} python -W ignore ${PYTHONSCRIPTS}format.py /${CONFIG}settings_format_${phaseformat}.yml /${CONFIG}settingsCreateInputPlan4res_${phasecreate}.yml ${DATASET}
