...
do
	...
	${P4R_ENV} sddp_solver -l ${INSTANCE}results_simul/bellmanvalues.csv -s -i ${scen} -S ${CONFIG}sddp_greedy.txt -c ${CONFIG} -p ${INSTANCE}nc4_simul/ ${INSTANCE}nc4_simul/SDDPBlock.nc4
